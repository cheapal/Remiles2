...
class CarrierDashboard1 extends StatefulWidget {
  const CarrierDashboard1({super.key});
  @override
  State<CarrierDashboard1> createState() => _CarrierDashboard1State();
}

class _CarrierDashboard1State extends State<CarrierDashboard1>
  ...
  void initState() {
    ...
    _topSectionAnimation = Tween<double>(begin: 1.0, end: 1.05).animate(
      CurvedAnimation(parent: _topSectionController, curve: Curves.easeInOut),
    );
  }
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            // Navigate to carrier dashboard 2
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const CarrierDashboard2(),
                              ),
                            );
                          },
                                ...
                                Container(
                                  ...
                                  child: const Column(
                                    ...
                                    children: [
                                      SizedBox(height: 40),
                                      Text(
                                        'Complete your profile setup to start booking loads',
                                        textAlign: TextAlign.center,
                                        style: TextStyle(
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: BottomNavigationBar(
                      ...
                      unselectedItemColor: offWhite.withOpacity(0.6),
                      ...
                      items: const [
                        ...
                        BottomNavigationBarItem(
                          icon: ImageIcon(
                            AssetImage('assets/trolly_icon.png'),
                            size: 29,
                          ),
                          label: 'Manage Loads',
                        ),
