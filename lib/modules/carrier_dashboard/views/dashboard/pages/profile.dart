...
class _ProfileState extends State<Profile> {
  ...
  Future<void> _deleteProfilePicture() async {
    try {
      ...
      if (carrier.profileImageUrl == null || carrier.profileImageUrl!.isEmpty) {
      ...
      try {
        await FirebaseService.deleteFileFromURL(carrier.profileImageUrl!);
      } catch (e) {
        // Log error but continue - the file might not exist or already be deleted
        print('Error deleting file from storage: $e');
      }

      // Update carrier profile to remove image URL
      await FirebaseService.updateCarrier(carrier.uid, {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        if (carrier?.profileImageUrl != null && carrier!.profileImageUrl!.isNotEmpty) ...[
                    ...
                    // Company Name
                    Text(
                      carrier?.companyName ?? 'Company Name',
                    ...
                    if (carrier != null)
                      Row(
                        ...
                        children: [
                          ...
                          _buildVerifiedChip(
                            isVerified: (carrier.isVerified || carrier.isPhoneVerified),
                          ),
                          const SizedBox(width: 12),
                          _buildStatChip(
