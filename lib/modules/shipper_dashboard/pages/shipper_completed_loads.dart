...
void main() {
  runApp(const MaterialApp(
    ...
    home: ShipperCompletedLoads(),
  ));
}

class ShipperCompletedLoads extends StatefulWidget {
  const ShipperCompletedLoads({super.key});

  @override
  State<ShipperCompletedLoads> createState() => _ShipperCompletedLoadsState();
}

class _ShipperCompletedLoadsState extends State<ShipperCompletedLoads>
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        _buildLoadsButton('Completed Loads', true, context),
                      ],
                    ),
                    const SizedBox(height: 20),

                    // Completed cards (same style as Manage_loads_3)
                    _buildLoadCard(context, status: 'Completed'),
  ...
  /// with a blue "Completed" badge on the right.
  Widget _buildLoadCard(BuildContext context, {required String status}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF6CA78A).withOpacity(0.2), // soft greenish shadow (spec)
            blurRadius: 13.4,
            spreadRadius: 2,
            offset: const Offset(0, 3),
          ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              // right side status + id + equipment
              Column(
