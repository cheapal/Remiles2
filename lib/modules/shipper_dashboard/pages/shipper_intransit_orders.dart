...
void main() {
  runApp(const MaterialApp(
    ...
    home: ShipperIntransit(),
  ));
}

class ShipperIntransit extends StatefulWidget {
  const ShipperIntransit({super.key});

  @override
  State<ShipperIntransit> createState() => _ShipperIntransitState();
}

class _ShipperIntransitState extends State<ShipperIntransit>
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Status buttons (In-Transit active)
                    Row(
                      children: [
                        _buildLoadsButton('Active Loads', false, context),
                        _buildLoadsButton('In-Transit', true, context),
                    ...
                    // Cards
                    _buildLoadCard(context, status: 'In-Transit'),
  ...
  /// but with In-Transit + Track on the right.
