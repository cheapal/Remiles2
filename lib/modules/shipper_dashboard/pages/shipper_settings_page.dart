...
class _ShipperSettingsPageState extends State<ShipperSettingsPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (shipper?.phoneNumber != null && mounted) {
  ...
  Future<void> _verifyPhoneOTP() async {
    ...
    try {
      ...
      if (shipper == null) {
        // Record error in Crashlytics
        final error = Exception('Shipper not found during phone verification');
        await FirebaseService.recordError(
          error,
          StackTrace.current,
          reason: 'Shipper user is null during phone OTP verification',
        );
        throw error;
      }
  ...
  Widget build(BuildContext context) {
    ...
    // Update phone controller when shipper data changes
    if (shipper?.phoneNumber != null && _phoneController.text != shipper!.phoneNumber) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (mounted) {
          _phoneController.text = shipper.phoneNumber!;
        }
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (shipper.phoneNumber != null) ...[
                      Container(
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                          color: shipper.isPhoneVerified 
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'Phone Number: ${shipper.phoneNumber}',
                                    style: TextStyle(
                                      fontSize: 14,
