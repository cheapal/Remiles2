...
void main() {
  runApp(const MaterialApp(
    ...
    home: ShipperBookedLoads(),
  ));
}

class ShipperBookedLoads extends StatefulWidget {
  const ShipperBookedLoads({super.key});

  @override
  State<ShipperBookedLoads> createState() => _ShipperBookedLoadsState();
}

class _ShipperBookedLoadsState extends State<ShipperBookedLoads>
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Active and Booked Loads buttons
                    Row(
                      children: [
                        _buildPrimaryButton(
                            'Active Loads', const Color(0xFFFFCF5F), Colors.black),
                        const SizedBox(width: 10),
                        _buildPrimaryButton(
                            'Booked Loads', const Color(0xFF195529), Colors.white),
                      ],
                    ),
                    const SizedBox(height: 20),

                    // Status buttons (Booked active)
                    Row(
                      children: [
                    ...
                    // Cards
                    _buildLoadCard(context, status: 'Booked'),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [Color(0xFFFFB236), Color(0xFFEE8F29)],
