...
class _ShipperLoadAiMatchState extends State<ShipperLoadAiMatch>
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _searchBar(hint: 'Search My Loads'),
                    ...
                    Row(
                      children: [
                        _bigButton('Available Loads', bg: Colors.white, textColor: Colors.black),
                        const SizedBox(width: 10),
                        _bigButton('My Bookings', bg: Colors.white, textColor: Colors.black),
                      ],
                    ),
                    const SizedBox(height: 16),
                    ...
                    Row(
                      children: [
                        _statusPill('In-Transit', 0, active: true),
                        _statusPill('Cancelled Loads', 1),
                        _statusPill('Completed Loads', 2),
                      ],
                    ),
                    const SizedBox(height: 16),
  ...
  // Big top buttons
  Widget _bigButton(String text, {required Color bg, required Color textColor}) {
    return Expanded(
      child: Container(
        height: 32.24,
        decoration: BoxDecoration(
  ...
  Widget _statusPill(String text, int index, {bool active = false}) {
    return Expanded(
      child: Padding(
