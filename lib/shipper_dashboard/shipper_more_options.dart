...
void main() {
  runApp(const MaterialApp(
    ...
    home: ShipperMoreOptions(),
  ));
}

class ShipperMoreOptions extends StatefulWidget {
  const ShipperMoreOptions({super.key});

  @override
  State<ShipperMoreOptions> createState() => _ShipperMoreOptionsState();
}

class _ShipperMoreOptionsState extends State<ShipperMoreOptions>
  ...
  Widget _buildOptionCard({required String title, required IconData icon}) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(icon, size: 80, color: const Color(0xFF195529)),
